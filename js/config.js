...
const DRAWING = {
  // 画布尺寸
  CANVAS: {
    WIDTH_DEFAULT: 1400,  // 增大宽度从1100到1400
    WIDTH_DISTANCE: 1900,  // 增大宽度从1800到1900
    WIDTH_7YAO: 1400,      // 增大宽度从1300到1400
    HEIGHT: 1300,          // 增大高度从1200到1300
    MAX_WIDTH: 2300
  },

  // 中心点和半径
  CENTER: {
    X: 1400 / 2,  // 700，更新为新的画布宽度中心
    Y: 1300 / 2,  // 650，更新为新的画布高度中心
    RADIUS: 400,  // 增大半径从315到400
    CROSS_PIXELS: 10  // 增大中心圆点从8到10
  },
  ...
  // 刻度配置
  SCALE: {
    R24: 380,        // 24节气圈半径，从295增大到380
    RX: 440,         // 28宿圈半径，从355增大到440
    R1_BASE: 400,    // 基础半径，从315增大到400
    R2_OFFSET: -20,  // 内圈偏移
    LINE_WIDTH: 1.2, // 刻度线宽
    HOUR_TICK: 6,    // 小时刻度长度
    SUB_TICK: 15     // 子刻度长度
