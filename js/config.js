...
// ==================== 常用恒星配置 ====================
const COMMON_STARS = [
  { name: '角宿一', ra: (13 * 3600 + 26 * 60 + 24.19) / 3600, dec: -(11 + 16 / 60 + 51.2 / 3600) },
  { name: '大角', ra: (14 * 3600 + 16 * 60 + 42.53) / 3600, dec: (19 + 3 / 60 + 31.4 / 3600) },
  { name: '大火', ra: (16 * 3600 + 30 * 60 + 47.83) / 3600, dec: -(26 + 28 / 60 + 54.1 / 3600) },
  { name: '参宿四·左肩', ra: (5 * 3600 + 56 * 60 + 25.85) / 3600, dec: (7 + 24 / 60 + 37.9 / 3600) },
  { name: '北落师门', ra: (22 * 3600 + 58 * 60 + 53.71) / 3600, dec: -(29 + 30 / 60 + 15.4 / 3600) },
  { name: '天狼', ra: (6 * 3600 + 46 * 60 + 10.59) / 3600, dec: -(16 + 44 / 60 + 57.5 / 3600) },
  { name: '毕宿五', ra: (4 * 3600 + 37 * 60 + 15.02) / 3600, dec: (16 + 33 / 60 + 18.8 / 3600) },
  { name: '南河三', ra: (7 * 3600 + 40 * 60 + 31.24) / 3600, dec: (5 + 9 / 60 + 54.5 / 3600) },
  { name: '河鼓二·牵牛', ra: (19 * 3600 + 51 * 60 + 52.56) / 3600, dec: (8 + 55 / 60 + 38.6 / 3600) },
  { name: '织女', ra: (18 * 3600 + 37 * 60 + 40.93) / 3600, dec: (38 + 48 / 60 + 8.9 / 3600) },
  { name: '开阳·武曲', ra: (13 * 3600 + 24 * 60 + 51.55) / 3600, dec: (54 + 48 / 60 + 2.3 / 3600) },
  { name: '摇光·破军', ra: (13 * 3600 + 48 * 60 + 26.97) / 3600, dec: (49 + 11 / 60 + 37 / 3600) }
];
